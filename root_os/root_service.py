...
class RootEventHandler(FileSystemEventHandler):
    ...
    def on_modified(self, event):
        ...
        ignored_files = [
            "ROOT.md", "HISTORY.md", "ROADMAP.md", 
            "state_manifest.json", "actions_queue.json", "core_dump.json"
        ]
...
if __name__ == "__main__":
    ...
    background_processes["dashboard_brain"] = start_background_process(
        "Dashboard Brain (Controller)", os.path.join(DASHBOARD_DIR, "dashboard_brain.py")
    )
